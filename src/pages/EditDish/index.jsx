...
export function EditDish() {
  ...
  // Funções de adicionar e remover ingredientes:
  ...
  // Função de atualizar dados do prato:
  async function handleUpdateDish() {
    ...
    if (!description) {
      return alert(
        'Erro: Você não informou uma descrição para o prato!'
      );
    }
          ...
          <Content>
            ...
            <div className='button'>
              <Button
                ...
                title={
                  loadingDelete ? 'Excluindo prato' : 'Excluir prato'
                }
